...
# Run the API project
run:
	dotnet run --project src/ProgressSoft.Presentation.API

# Run the API project
watch:
	dotnet watch --project src/ProgressSoft.Presentation.API
...
migrate:
	dotnet ef migrations add $(name) --project src/ProgressSoft.Infrastructure --startup-project src/ProgressSoft.Presentation.API
